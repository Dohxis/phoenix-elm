...
var _user$project$Model$DashboardRoute = {ctor: 'DashboardRoute'};
var _user$project$Model$HomepageRoute = {ctor: 'HomepageRoute'};

var _user$project$Action$RedirectTo = function (a) {
	return {ctor: 'RedirectTo', _0: a};
};
var _user$project$Action$OnLocationChange = function (a) {
	return {ctor: 'OnLocationChange', _0: a};
};

var _user$project$Pages_Dashboard_Index$view = function (model) {
	return A2(
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('btn tbn-default'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Action$RedirectTo(_user$project$Model$HomepageRoute)),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Go to Homepage'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Pages_Homepage_Index$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_user$project$Action$RedirectTo(_user$project$Model$DashboardRoute)),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Go to Dashboard'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Routing$view = function (model) {
	var _p0 = model.route;
	switch (_p0.ctor) {
		case 'HomepageRoute':
			return _user$project$Pages_Homepage_Index$view(model);
		case 'DashboardRoute':
			return _user$project$Pages_Dashboard_Index$view(model);
		default:
...
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Model$HomepageRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Model$DashboardRoute,
...
var _user$project$Utils_Router$stringToPath = function (route) {
	var _p0 = route;
	switch (_p0.ctor) {
		case 'HomepageRoute':
			return '/';
...
var _user$project$Utils_Router$redirectTo = function (route) {
	return _elm_lang$navigation$Navigation$newUrl(
		_user$project$Utils_Router$stringToPath(route));
};
	...
	function (action, model) {
		...
		if (_p0.ctor === 'OnLocationChange') {
			...
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Utils_Router$redirectTo(_p0._0)
			};
		}
	});
...
var _user$project$Main$main = A2(
	...
	_user$project$Action$OnLocationChange,
	{
		init: _user$project$Main$init,
		view: _user$project$Routing$view,
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Model.Route":{"args":[],"tags":{"HomepageRoute":[],"NotFoundRoute":[],"DashboardRoute":[]}},"Action.Action":{"args":[],"tags":{"OnLocationChange":["Navigation.Location"],"RedirectTo":["Model.Route"]}}},"aliases":{"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Action.Action"},"versions":{"elm":"0.18.0"}});
}
